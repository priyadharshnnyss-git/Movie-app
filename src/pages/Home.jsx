...
const Home = () => {
  ...
  useEffect(()=>{
    let url=`https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=7cf996ed5206457ff43959e8ca1d19fa`

    if(search){
      url= `https://api.themoviedb.org/3/search/movie?query=${search}&api_key=7cf996ed5206457ff43959e8ca1d19fa`
    }
    fetch(url)
